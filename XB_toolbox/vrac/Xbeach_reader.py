...
def gif_transects(XB_data, transect=130):
    """ 
    Permet de faire un gif crosshore d'un transect avec la hauteur de vague et le niveau d'eau instantané
    
    XB_data est un objet XB_Loader du type XB_data = XBr.XB_Loader(xboutput.nc)
    ...
    time = ax2.annotate('', xy=(1, 0.5), xycoords='axes fraction')
