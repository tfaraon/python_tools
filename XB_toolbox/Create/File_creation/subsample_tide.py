...
df = pd.read_csv(
    "/home/tfrn/Documents/Stage_TDV/Données hydro/Data_niveau_lagunes/tide_SBL_10min.csv",
    sep=",",
    decimal=".",
    names=['temps', 'hauteur'])

intervalle_initial = 600  # en secondes
...
df_subsamp.to_csv("/home/tfrn/Documents/Stage_TDV/XBeach/Calibration/2D/2022/Test_19/Tideloc/tide_SBL.txt", index=False, header= False, decimal='.', sep=' ')
